...
<html lang="en">
  <head>
    ...
    function borrar(codigo) {
        var mensaje;
        var opcion = confirm("El producto será eliminado de la base de datos, ¿seguro que desea continuar con esta acción?");
        if (opcion == true) {
          document.frm_listEliminarProducto.micodigo.value = codigo;
          //alert(codigo);
          document.frm_listEliminarProducto.submit();
...
<!--/*********************************FORMULARIO PARA EL LISTADO*****************************************************/ -->
                 <form method="post" action="modulos\mdl_eliminarProducto.php" name="frm_listEliminarProducto" id="frm_listEliminarProducto" style="width: auto; height: auto;">
      ...
      if($filtro1 || $filtro2 || $filtro3){
        ...
        //  if($filtro1 == $alumno['curp'] || $filtro2 == $alumno['nombre'] || $filtro3 == $alumno['apellidos']){
          ...
          if($filtro1 == $producto['id'] || $filtro2 == $producto['nombre'] || $filtro3 == $producto['codigo']){
            ...
            <td style='text-align:center'><img width='30' height='30' src='imgs/delete.png' onClick='borrar(\"".$producto['id']."\");'></td>
            </tr>";
          }
