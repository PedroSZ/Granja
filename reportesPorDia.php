                        ...
                        echo"
                                   ...
                                   if($registros){
                                    echo "
                                      ...
                                      if($filtro1 || $filtro2 || $filtro3 || $filtro4 || $fecha){/* primer si filtro*/
                                      foreach ($registros as $regist) {
                                       
                                            if($filtro1 == $regist['id'] || $filtro2 == $regist['codigo'] || $filtro3 == $regist['nombre'] || $filtro4 == $regist['peso'] || $fecha ==$regist['fecha']){ /*compara filtro con registro*/
                                          echo "<tr>        
                                          <td>".$regist['id']."</td> 
                                          <td>".$regist['fecha']."</td>                                  
                                          <td>".$regist['nombre']."</td>
